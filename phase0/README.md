...
## Network boundary and the Phase-0 success criterion

This code targets **Story Aeneid testnet, chain ID 1315**, and never sends
mainnet transactions or real funds. The Phase-0 success criterion in the
project's internal PRD (unpublished) targets **Story mainnet, chain ID 1514**,
and requires broader proof than this testnet write path. Aeneid results are
useful engineering evidence; they **do not satisfy that Phase-0 success
criterion**.

...
Design: section 4 of the project's internal 2026-07-11 "reframe & Pi-Wielder" design document
(unpublished); the claims it makes are restated and demonstrated below.
...
per-call pricing amplifies agentic chattiness (relevant to the pricing-model
spike in the project's internal PRD, unpublished). (The session ledger renders 8 entries / $0.328
